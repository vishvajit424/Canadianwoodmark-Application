  ...
  >
    ...
    >
      ...
      <a href="index.html" class="lg:hidden">
        <img class="dark:hidden" src="{{$settings->logo  ? asset('storage/' . $settings->logo)
                : asset('images/avatar.png') }}" alt="Logo" style="width: 100px;" />
        <img
          class="hidden dark:block"
          src="{{$settings->logo  ? asset('storage/' . $settings->logo)
                : 'CWM' }}"
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="{{auth()->user()->userdetails->profile_image  ? asset('storage/' . auth()->user()->userdetails->profile_image)
                : asset('/assets/images/user/owner.jpg') }}" alt="{{ Auth::user()->name }}" />
          </span>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();" class="group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                                <svg
